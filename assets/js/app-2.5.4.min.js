...
(function(X) {
    ...
    r.prototype.Symbol = function(c) {
        ...
        1 == c && (this.downSymbolMob.el.style.display = "none", this.downSymbolDesk.el.style.display = "none", this.upSymbolMob.el.style.display =
    ...
    r.prototype.mainGaugeProgress = function(c) {
        ...
        0 < c && (this.mainGaugeBlue_Desk.el.style.strokeOpacity =
        ...
        0 == a && 1E3 < d ? (this.mainGaugeBlue_Mob.el.style.strokeDashoffset = 681 <= a ? 681 : a, this.mainGaugeWhite_Mob.el.style.strokeDashoffset =
    ...
    r.prototype.pingResults = function(c, d) {
        var a = c;
        "Ping" === d && (1 <= a && 1E4 > a ? (this.pingResult.el.textContent = Math.floor(a),
            this.pingMobres.el.textContent = Math.floor(a)) : 0 <= a && 1 > a && (0 == a && (a = 0), this.pingResult.el.textContent = a, this.pingMobres.el.textContent = a));
    ...
    r.prototype.downloadResult = function(c) {
        ...
        1E5 <= c && (this.downResult.el.textContent = c.toFixed(1), this.downResult.el.style.fontSize =
            "18px")
    };
    ...
    var jb = function() {
        ...
        function d() {
            function b() {
                1 <= l ? (--l, e.LiveSpeed(l,
                    "countDown")) : 0 >= l && (clearInterval(g), G = !0, Z = void 0, d())
            }
            ...
            !0 === G && ("Ping" ===
                A ? f() : "Download" === A ? f() : "Upload" === A ? f() : !1 === A && f())
        }
        ...
        function t() {
            ...
            var l = setInterval(function() {
                ...
                "Upload" ==
                m && 1 === I && (e.Symbol(1), m = "initup", e.showStatus("Initializing.."), e.LiveSpeed("...", "speedToZero"), za = x.uRandom(ulDataSize, b), A && (aa = 1));
                "Uploading" === m && (1 == aa && (aa = 2, e.showStatus("Testing upload speed.."), y = 0, x.reset(), e.reset(), Ra = g = (window.performance.now() - va) / 1E3, e.progress(!1, ulDuration + 2.5), ulDuration += g), e.showStatus("Gbps upload"), T = (window.performance.now() - va) / 1E3, q("up"), e.mainGaugeProgress(y), e.LiveSpeed(y), e.Graph(y, 1), U = x.AvgSpeed(y, Aa, ulDuration), T >= ulDuration && 1 == I && (ja = P, e.uploadResult(U),
                    e.GaugeProgresstoZero(y, "SendR"), za = void 0, e.showStatus("All done"), e.Symbol(2), m = "busy", I = 0));
                if ("Error" === m) {
                    ...
                    g.innerHTML = '<a xlink:href="https://openspeedtest.com/FAQ.php?ref=NetworkError" style="cursor: pointer" target="_blank"></a>';
                ...
                "SendR" === m && (e.showStatus("All done"), g = document.createElement("div"), g.innerHTML = '<a xlink:href="https://openspeedtest.com?ref=Self-Hosted-Outro&run=5" style="cursor: pointer" target="_blank"></a>', 
                u = g.querySelector("a"), e.oDoLiveSpeed.el.textContent = fb, C = document.getElementById("oDoLiveSpeed"), 
                u.innerHTML = C.innerHTML, 
                C.innerHTML = g.innerHTML, 
                location.hostname != Ba.toLowerCase() + Sa ? (ba = "https://" + Ba.toLowerCase() + Sa + "/results/show.php?&d=" + R.toFixed(3) + "&u=" + U.toFixed(3) + "&p=" +
                    Ca + "&j=" + Da + "&dd=" + (ia / 1048576).toFixed(3) + "&ud=" + (ja / 1048576).toFixed(3) + "&ua=" + Ta, ba = encodeURI(ba), g = document.getElementById("resultsData"), g.setAttributeNS("http://www.w3.org/1999/xlink", "xlink:href", ba), g.setAttribute("target", "_blank"), saveData && Y(5)) : Y(3), m = "busy", clearInterval(l))
            }, 100)
        }
        ...
        function M(b) {
            ...
            z[b].onprogress = function(g) {
                if (1 ===
                    I) return z[b].abort(), z[b] = null, z[b] = void 0, delete z[b], !1;
        ...
        x.addEvt(e.startButtonMob.el, "click",
            d);
        ...
        if (setPingTimeout && ("string" === typeof k.out || "string" ===
                typeof k.o)) {
        ...
        var Va = 0,
            ...
            Y = function(b) {
                ...
                l.onreadystatechange = function() {
                    4 == l.readyState && 200 == l.status && (V = l.responseText.trim(), 2 == b && (eb = V), 1 == b && (La =
                        V), 3 == b && setTimeout(function() {
                        location.href = ta + V
                    }, 1500), 6 == b && (openSpeedTestServerList = JSON.parse(V), G = !0, d()), 7 == b && (e.YourIP.el.textContent = V))
                };
                2 == b && (ea = "r=n");
                3 == b && (ea = "r=l&d=" + R + "&u=" + U + "&dd=" + ia / 1048576 + "&ud=" + ja / 1048576 + "&p=" + Ca + "&do=" + db + "&S=" + eb + "&sip=" + La + "&jit=" + Da + "&ua=" + Ta);
                5 == b && (ea = ba);
                6 == b && (ea = "r=s");
                l.send(ea)
            }
